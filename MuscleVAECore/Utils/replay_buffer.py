...
from MuscleVAECore.Utils.index_counter import index_counter
...
class ReplayBuffer(object):
    ...
    def generate_data_loader(self, name_list, rollout_length, mini_batch_size, mini_batch_num):
        ...
        index = index_counter.sample_rollout(
                self.feasible_index(rollout_length),
                mini_batch_size* mini_batch_num, 
                rollout_length 
                )

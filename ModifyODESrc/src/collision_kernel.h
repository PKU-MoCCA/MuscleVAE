...
struct dxGeom : public dBase {
  ...
  void computePosr_pos_with_input(dMatrix3 input_rot, dVector3 input_pos, dVector3 res);
  
  void computePosr_r_with_input(dMatrix3 input_rot, dVector3 input_pos, dMatrix3 res);

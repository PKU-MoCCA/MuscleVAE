...
ODE_API void dGeomGetPosition_with_input_matrix(dxGeom *g, dMatrix3 R, dVector3 pos, dVector3 res);

ODE_API void dGeomGetRotation_with_input_matrix(dxGeom *g, dMatrix3 R, dVector3 pos, dMatrix3 res);
